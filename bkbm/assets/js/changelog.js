$(function () {
  ...
  var metaData = ["1.6.0", "25/05/2025"]
  updateMetaInfo(metaData)

  // Just add a new row.
  var changeLogData = [
    // Add a new row below this comment.
    ["2025, May, 25 - v 1.6.0", ["Updated: Plugin shortcode editor icon and overlay issue for Gutenberg editor.", "Updated: Plugin Scheduler functions bug.", "Updated: Plugin Custom and sortable columns.", "Updated: Plugin dashboard widget and notices."]],
